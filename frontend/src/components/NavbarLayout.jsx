        ...
        <Sheet open={isOpen} onOpenChange={onClose}>
            ...
            >
                ...
                <nav className="flex flex-col gap-2">
                    ...
                    {/* In Association With - Only show after login */}
                    <Collapsible
                    ...
                    >
                        <CollapsibleTrigger className="flex items-center justify-between w-full px-4 py-3 rounded-lg hover:bg-secondary transition-all duration-300 group">
                            ...
                            <ChevronDown
                                className={`w-5 h-5 text-primary transition-transform duration-300 ${isAssociationOpen ? 'rotate-180' : ''
                                    }`}
                            />
                        </CollapsibleTrigger>
                        ...
                        <CollapsibleContent className="mt-2 space-y-1 animate-accordion-down">
                            {ministries.map((ministry, index) => (
                                <button
                                    ...
                                    className="flex items-start gap-2 w-full px-6 py-3 text-left hover:bg-secondary/50 rounded-lg transition-all duration-300 group"
                                    style={{
